...
//     description: z
//       .string()
//       .min(10,'minumum 10 characters must')
...
//   // Fetch product and category options from the API
...
//     select: (data) =>
//       data.map((category) => ({
//         label: category.categoryName, // Adjust based on your API response structure
//         value: category._id, // Use the actual ID field from your API
//       })),
//   });
...
//     select: (data) =>
//       data.map((product) => ({
//         label: product.name, // Adjust based on your API response structure
//         value: product._id, // Use the actual ID field from your API
//       })),
//   });
...
//   // TanStack Query mutation for creating an offer
